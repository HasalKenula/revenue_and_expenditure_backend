...
//             $landMinistryRows = [
//                 ['trno' => 308, 'program' => 3, 'project' => 2, 'sub_project' => 1, 'object' => 2502, 'subject_name' => 'aa'],
//                 ['trno' => 308, 'program' => 3, 'project' => 2, 'sub_project' => 2, 'object' => 2502, 'subject_name' => 'bb'],
...
{
    /**
     * Get PSD Report data with all six ministries and subject names from budgets table
     */
    public function getData(Request $request)
    {
        try {
    ...
    /**
     * Add subject names from budgets table to rows and clean them
     */
    private function addSubjectNames($rows)
    {
        foreach ($rows as &$row) {
            ...
            // Clean the subject name by removing "PSD" and parentheses
    ...
    /**
     * Clean subject name by removing "PSDG" and parentheses
     */
    private function cleanSubjectName($name)
    {
        ...
        // Remove (PSDG), (PSDG), PSDG from the end
        $cleaned = preg_replace('/\s*\(?PSDG\)?\s*$/i', '', $name);
