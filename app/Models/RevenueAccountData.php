...
class RevenueAccountData extends Model
{
    use HasFactory;

    protected $table = 'revenue_account_data';
    ...
    /**
     * Get the account number that owns this revenue data.
     */
    ...
    /**
     * Get the estimate that owns this revenue data.
     */
