...
class RevenueCrossEntryAccountController extends Controller
{
    /**
     * Get Revenue Cross Entry Account Report data
     */
    public function getData(Request $request)
    {
        try {
            ...
            \Log::error('Error in RevenueCrossEntryAccount getData: ' . $e->getMessage());
            return response()->json([
                'success' => false,
    ...
    public function getFilterOptions(Request $request)
    {
        try {
            ...
            \Log::error('Error in RevenueCrossEntryAccount getFilterOptions: ' . $e->getMessage());
            return response()->json([
                'success' => false,
                'message' => $e->getMessage()
            ], 500);
    ...
    //             ->header('Content-Disposition', "attachment; filename=revenue_cross_entry_account_{$year}.csv");

    //     } catch (\Exception $e) {
    //         \Log::error('Error in RevenueCrossEntryAccount exportCsv: ' . $e->getMessage());
    //         return response()->json([
    //             'success' => false,
    //             'message' => $e->getMessage()
    //         ], 500);
